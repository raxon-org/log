...
namespace Package\Raxon\Org\Log\Controller;
...
class Cli extends Controller {
    ...
    const INFO = [
        '{{binary()}} raxon_org/log                     | log options',
        '{{binary()}} raxon_org/log setup               | Log setup',
        '{{binary()}} raxon_org/log archive <archive>   | Zip <archive> into <archive>.{literal}{date(\'Y-m-d H:i:s\')}{/literal}.log.zip',
    ];
